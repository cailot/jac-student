...
.background-animation {
    ...
    width: 100%;
    height: 100%;
    background-image: url('${pageContext.request.contextPath}/image/online-login.jpeg');
...
<div id="background" class="container mt-5">
    ...
    <div class="row h-100 justify-content-center align-items-center">		
		<div class="card">
            <h3 class="card-header text-center" style="background: #727cb8; color: #daddef !important;">Jac eLearning</h3>
			<div class="card-body">
                <form:form  action="${pageContext.request.contextPath}/online/processLogin" method="POST">
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<span class="input-group-text text-white" style="background: #727cb8;"><i class="bi bi-person-fill text-warning" aria-hidden="true"></i></span>
									</div>
					...
					<div class="row mb-3">
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="input-group">
									<div class="input-group-prepend">
									<span class="input-group-text text-white" style="background: #727cb8;"><i class="bi bi-unlock-fill text-warning" aria-hidden="true"></i></span>
									</div>
					...
					<div class="row mb-3">
						<div class="col-md-12">
							...
							<input type="submit" class="btn btn-primary btn-lg btn-block" style="background: #727cb8; border-color: #727cb8; color: #daddef !important;" value="Login" name="submit">
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
