...
var isEmailSending = false; // Flag to prevent double-click

function sendEmail() {
    // Prevent double-click
    if (isEmailSending) {
        console.log('Email is already being sent, please wait...');
        return;
    }
    ...
    const submitButton = document.getElementById('selectionCount');
    ...
    $.ajax({
        ...
        success : function(response) {
            ...
            if (response.status === 'success') {
                // Change button text to SUBMITTED and keep it disabled
