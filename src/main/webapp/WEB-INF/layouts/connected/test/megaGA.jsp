...
const TEST_TYPE = 3; // 3 is MEGA GA 
const MOVIE = 0;
const PDF = 1;
const DONE= 'DONE';
...
<div class="col-md-12 pt-3">
    <div class="card-body text-center">
        <h2 style="color: #6c757d; font-weight: bold; text-transform: uppercase; text-shadow: 2px 2px 4px rgba(168, 179, 247, 1);">Mega General Ability</h2>
    </div>
</div>
