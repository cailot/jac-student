...
$(function() {
    $.ajax({
        ...
        success: function(data) {
            ...
            document.getElementById("testModalLabel").innerHTML = 'Revision Mathematics Test - Set <span id="dialogSet" name="dialogSet" class="text-warning"></span>';            
        },
...
<div class="col-md-12 pt-3">
    <div class="card-body text-center">
        <h2 style="color: #6c757d; font-weight: bold; text-transform: uppercase; text-shadow: 2px 2px 4px rgba(168, 179, 247, 1);">Revision Mathematics</h2>
    </div>
</div>
