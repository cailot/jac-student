...
$(function() {
    $.ajax({
        ...
        success: function(data) {
            ...
            document.getElementById("practiceModalLabel").innerHTML = 'Mega General Ability Practice - Set <span id="dialogSet" name="dialogSet" class="text-warning"></span>';            
            document.getElementById("practiceAnswerModalLabel").innerHTML = 'Mega General Ability Practice - Set <span id="dialogAnswerSet" name="dialogAnswerSet" class="text-warning"></span>';            
        },
