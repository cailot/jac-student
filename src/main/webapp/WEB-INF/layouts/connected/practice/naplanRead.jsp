...
const PRACTICE_TYPE = 5; // 5 is NAPLAN Reading
const MOVIE = 0;
const PDF = 1;
const DONE= 'DONE';
...
$(function() {
    $.ajax({
        ...
        success: function(data) {
            ...
            document.getElementById("practiceModalLabel").innerHTML = 'NAPLAN Reading Practice - Set <span id="dialogSet" name="dialogSet" class="text-warning"></span>';            
            document.getElementById("practiceAnswerModalLabel").innerHTML = 'NAPLAN Reading Practice - Set <span id="dialogAnswerSet" name="dialogAnswerSet" class="text-warning"></span>';            
        },
...
<div class="col-md-12" style="padding: 30px;">
    <div class="card-body text-center">
        <h2 style="color: #6c757d; font-weight: bold; text-transform: uppercase;">NAPLAN Reading</h2>
    </div>
</div>
