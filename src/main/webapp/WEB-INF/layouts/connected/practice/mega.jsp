<script>
const PRACTICE_GROUP = 1; // 1 is MEGA
const DONE= 'DONE';
$(function() {
    $.ajax({
        url : '${pageContext.request.contextPath}/connected/summaryPractice/' + PRACTICE_GROUP + '/' + studentId,
        method: "GET",
...
<div class="col-md-12 pt-3">
    <div class="card-body text-center">
        <h2 style="color: #6c757d; font-weight: bold; text-transform: uppercase; text-shadow: 2px 2px 4px rgba(235, 177, 249, 1);">Mega Practice</h2>
    </div>
</div>
