...
public interface OnlineSessionService {
	...
	List<OnlineSessionDTO> getOnlineSessionByGradeNSetNYear(String grade, int set, int year); 

	// get grade for online session
	String getOnlineSessionGrade(Long studentId, int year, int week);

	// get latest enrolment grade (most recently registered active enrolment)
	String getLatestEnrolmentGrade(Long studentId);
