...
public class AssessmentServiceImpl implements AssessmentService {
	...
	@Override
	public boolean existsGuestStudentAssessment(Long studentId, Long assessId) {
		try{
			return guestStudentAssessmentRepository.existsByGuestStudentIdAndAssessmentId(studentId, assessId);
		}catch(Exception e){
			return false;
		}
	}
