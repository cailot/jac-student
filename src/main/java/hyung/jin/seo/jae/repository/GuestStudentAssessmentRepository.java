...
public interface GuestStudentAssessmentRepository extends JpaRepository<GuestStudentAssessment, Long> {
	...
	// Correct, id-based Spring Data methods (safe to use in services/controllers)
	Optional<GuestStudentAssessment> findFirstByGuestStudentIdAndAssessmentId(Long studentId, Long assessId);

	boolean existsByGuestStudentIdAndAssessmentId(Long studentId, Long assessId);
